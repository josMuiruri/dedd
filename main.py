...
# title of the window
root.title("ENCODE DECODE - Message Encode and Decode")

# label

Label(root, text='ENCODE', font='arial 20 bold').pack()
Label(root, text='DECODE', font='arial 20 bold').pack(side=BOTTOM)
